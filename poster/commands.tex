...
\definecolor{lightgray}{RGB}{135, 135, 135}
\definecolor{darkred}{RGB}{255, 0, 0}
\definecolor{darkgreen}{RGB}{25, 100, 25}
%\definecolor{darkmagenta}{RGB}{143, 45, 86}
%\definecolor{darkmagenta}{RGB}{66, 32, 64}
%\definecolor{darkmagenta}{RGB}{183, 68, 184}
\definecolor{darkmagenta}{RGB}{255, 0, 255}
...
\def\App{App\onedot} \def\List{List\onedot}
\makeatother
...
\newcommand{\Cifar}{CIFAR\xspace}
\newcommand{\CifarT}{CIFAR10\xspace}
\newcommand{\CifarH}{CIFAR100\xspace}

\newcommand{\Normal}{\textsc{Normal}\xspace}
\newcommand{\Quant}{\textsc{RQuant}\xspace}
\newcommand{\Clipping}[1][]{\textsc{Clipping}\textsubscript{#1}\xspace}
\newcommand{\Pattern}[1][]{\textsc{PattBET}\textsubscript{#1}\xspace}
\newcommand{\Random}[1][]{\textsc{RandBET}\textsubscript{#1}\xspace}
\newcommand{\RandomMSB}{\textsc{MSBBET}\xspace}

\newcommand{\gray}[1]{\noindent{\color{gray}{#1}}}
\newcommand{\red}[1]{\noindent{\color{darkred}{#1}}}
\newcommand{\green}[1]{\noindent{\color{darkgreen}{#1}}}
\newcommand{\magenta}[1]{\noindent{\color{darkmagenta}{#1}}}
\newcommand{\blue}[1]{\noindent{\color{darkblue}{#1}}}

\newcommand{\david}[1]{\noindent{\color{red}{David: #1}}}
\newcommand{\matthias}[1]{\noindent{\color{blue}{Matthias: #1}}}
\newcommand{\bernt}[1]{\noindent{\textcolor[rgb]{0.08, 0.38, 0.74}{\textbf{Bernt: #1}}}}
\newcommand{\nandhini}[1]{\noindent{\color{violet}{Nandhini: #1}}}

\renewcommand{\david}[1]{}
%\renewcommand{\matthias}[1]{}
%\renewcommand{\bernt}[1]{}
\renewcommand{\nandhini}[1]{}